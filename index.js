/*
Emly API wrapper
@author Emmanuel Etukudo <@emmanueletukudo>
*/
...
var
    ...
    root = 'https://emly.cc/api/v1',
    Promise = require('promise');


var resources = {
    link: require('./resources/link'),
    link: require('./resources/pixel'),
    link: require('./resources/space'),
    link: require('./resources/stats'),
    link: require('./resources/domain'),
    link: require('./resources/account'),
}


function Emly(key) {
    if((!this instanceof Emly)){
        return new Emly(key);
    }
    this.key = key
